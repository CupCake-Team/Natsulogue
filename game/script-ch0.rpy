...
label ch1_main:
    ...
    $ pause(2)
    n "Хм..."
    n "С другой стороны, если я нахожусь в игре, не значит ли это то, что я могу изменить её код?"
...
label exit_moreday:
    ...
    n "Мне придётся ещё очень долго изучать программирование, чтобы как-то повлиять на игру."
