...
label set_name:
    if input_count == 0:
        ...
        $ input_count_s = 0
    call set_name_input
    if player.lower() in react_names:        
        if player.lower() == "natsuki" or player.lower() == "нацуки":
            if input_count_s == 0 or input_count_m == 0 or input_count_y == 0:       
                if input_count_n == 1:
                    n "Эй, это же моё имя!"
