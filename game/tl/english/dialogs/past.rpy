...
# game/dialogs/past.rpy:32
translate english dia_past_8aff7279:

    # n "Кстати, там уже состояли Юри и Сайори и всё было бы хорошо, но..."
    n ""

# game/dialogs/past.rpy:33
translate english dia_past_edb7fd89:

    # n "Они все молча осуждали мою страсть к манге, что это, видите ли, детская забава."
    n ""

# game/dialogs/past.rpy:34
translate english dia_past_c242c0f3:

    # n "В итоге я чуть ли не покинула клуб, но в конце концов вся заваренная каша оказалась расхлёбана."
    n ""

# game/dialogs/past.rpy:35
translate english dia_past_9947da99:

    # n "Мы приняли интересы друг друга, пусть и с небольшой натяжкой, в конце концов помирившись и всё стало идеально."
    n ""

# game/dialogs/past.rpy:36
translate english dia_past_9d8f34b2:

    # n r1b "..."
    n r1b ""

# game/dialogs/past.rpy:37
translate english dia_past_f44b633a:

    # n r1f "Ха–ха–ха!"
    n r1f ""

# game/dialogs/past.rpy:38
translate english dia_past_fdbbbb99:

    # n "Всё {i}это{/i} оказалось ложью!"
    n ""

# game/dialogs/past.rpy:39
translate english dia_past_8a445490:

    # n r1e "Если та же Сайори перестала принижать мои интересы, а Юри просто молчала, то Моника..."
    n r1e ""

# game/dialogs/past.rpy:40
translate english dia_past_2bedb96c:

    # n "Я сейчас даже не говорю про то, что она переставляла мою мангу без спроса и в целом совала нос не в свои дела."
    n ""

# game/dialogs/past.rpy:41
translate english dia_past_4ff4ec6e:

    # n "Она манипулировала сознанием участников клуба и, как ты прекрасно знаешь, доводила своих поруг до самоубийства."
    n ""

# game/dialogs/past.rpy:42
translate english dia_past_6a26b60c:

    # n r1b "Это просто..."
    n r1b ""

# game/dialogs/past.rpy:43
translate english dia_past_816ae318:

    # n r1e "У меня нет слов, предательство какое–то."
    n r1e ""

# game/dialogs/past.rpy:44
translate english dia_past_056d5d93:
...
# game/dialogs/past.rpy:45
translate english dia_past_b872a5f4:

    # n r1a "После такого я не могу воспринимать это место в положительном ключе."
    n r1a ""

# game/dialogs/past.rpy:46
translate english dia_past_1535ee9a:

    # n r1b "Хорошо, что тебя не было на моём месте..."
    n r1b ""

# game/dialogs/past.rpy:47
translate english dia_past_88a9c29b:

    # n r1e "Это был ужас."
    n r1e ""

# game/dialogs/past.rpy:58
translate english dia_past_6f048d8e:

    # n r1e "Это ещё мягко сказано..."
    n r1e ""

# game/dialogs/past.rpy:59
translate english dia_past_02c5f293:

    # n "Никогда не думала, что она может вести себя так безрассудно."
    n ""

# game/dialogs/past.rpy:60
translate english dia_past_eb0bd5b6:

    # n r1b "Моника всегда проявляла чуткость и поддерживала меня и остальных..."
    n r1b ""

# game/dialogs/past.rpy:61
translate english dia_past_95ccba3d:

    # n r1e "И всё это для того, чтобы потом обращаться с нами как со скотом!"
    n r1e ""

# game/dialogs/past.rpy:62
translate english dia_past_93e7449b:

    # n "Ходить по трупам своих подруг, чтобы достичь какой-то призрачной цели..."
    n ""

# game/dialogs/past.rpy:63
translate english dia_past_f6f7a231:

    # n "А я ведь считала её хорошей подругой."
    n ""

# game/dialogs/past.rpy:64
translate english dia_past_fd7e6e96:

    # n "Дискуссионный клуб, оказывается, очень хорошо обучает людей врать и при этом не краснеть."
    n ""

# game/dialogs/past.rpy:65
translate english dia_past_39176a85:

    # n r1b "Я не знаю, осталась ли она ещё в игре или нет, но если, Моника, ты это слышишь..."
    n r1b ""

# game/dialogs/past.rpy:66
translate english dia_past_19b051b3:

    # n r1j "Можешь раскаиваться хоть миллион лет, не прощу!"
    n r1j ""

# game/dialogs/past.rpy:67
translate english dia_past_4ce17d03:

    # n "Из-за тебя моих настоящих подруг больше нет!"
    n ""

# game/dialogs/past.rpy:68
translate english dia_past_823180d3:

    # n "Ненавижу тебя!"
    n ""

# game/dialogs/past.rpy:69
translate english dia_past_4d40d06f:

    # n r1k "..."
    n r1k ""

# game/dialogs/past.rpy:70
translate english dia_past_c92fe525:

    # n r1l "Наверное сейчас это выглядело глупо, но мне нужно было выговориться."
    n r1l ""

# game/dialogs/past.rpy:71
translate english dia_past_282650f1:

    # n r1n "Мне хочется высказать ей лично куда больше ласковых слов..."
    n r1n ""

# game/dialogs/past.rpy:74
translate english dia_past_a6288973:

    # n r1e "VGhhdCdzIHB1dHRpbmcgaXQgbWlsZGx5Li4u"
    n r1e ""

# game/dialogs/past.rpy:75
translate english dia_past_78ed3272:

    # n "SSBuZXZlciB0aG91Z2h0IHNoZSBjb3VsZCBhY3Qgc28gcmVja2xlc3NseS4="
    n ""

# game/dialogs/past.rpy:76
translate english dia_past_c47fcccc:

    # n r1b "TW9uaWthIGhhcyBhbHdheXMgYmVlbiBzZW5zaXRpdmUgYW5kIHN1cHBvcnRpdmUgb2YgbWUgYW5kIHRoZSBvdGhlcnMuLi4="
    n r1b ""

# game/dialogs/past.rpy:77
translate english dia_past_62a0cfa7:

    # n r1e "QW5kIGFsbCB0aGlzIHRvIHRoZW4gdHJlYXQgdXMgbGlrZSBjYXR0bGUh"
    n r1e ""

# game/dialogs/past.rpy:78
translate english dia_past_f4f3ffbd:

    # n "V2Fsa2luZyBvdmVyIHRoZSBkZWFkIGJvZGllcyBvZiBoZXIgZnJpZW5kcyB0byBhY2hpZXZlIHNvbWUgZ2hvc3RseSBnb2FsLi4u"
    n ""

# game/dialogs/past.rpy:79
translate english dia_past_78b601f2:

    # n "QW5kIEkgdGhvdWdodCBzaGUgd2FzIGEgZ29vZCBmcmllbmQu"
    n ""

# game/dialogs/past.rpy:80
translate english dia_past_1cc35b31:
...
translate english strings:
    ...
    # game/dialogs/past.rpy:18
    old "{i}Что ты думаешь о литературном клубе?{/i}"
    new ""

    # game/dialogs/past.rpy:18
    old "{i}Ты ненавидишь Монику за её поступки?{/i}"
    new ""

    # game/dialogs/past.rpy:18
    old "{i}Что скажешь про Юри?{/i}"
    new ""

    # game/dialogs/past.rpy:18
    old "{i}Как ты относишься к Сайори?{/i}"
    new ""

    # game/dialogs/past.rpy:18
    old "{i}Что бы ты делала на месте Моники?{/i}"
    new ""
