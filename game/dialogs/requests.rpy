    ...
    menu:
            ...
            if persistent.repeat == 0:
                ...
                if (not renpy.mobile):
                    ...
                    if persistent.ch_mus != True:
                        ...
                        n "Я конечно не специалист, но мне кажется, что встретить новеллу на телефоне – это та ещё редкость."
        ...
        "{i}Я бы хотел поменять музыку...{/i}" if persistent.mus_repeat == 0 or persistent.mus_repeat == 1:
            ...
            if persistent.mus_repeat == 0:
                n "Хм..."
                n "Думаю, я смогу устроить нечто подобное, если найду способ, как это сделать."
