label dia_past:
    ...
    menu:
        ...
        "{i}Что скажешь про Юри?{/i}":
            ...
            n "Да, у нас возникали какие–то споры, но это только потому, что я и она имели противоположные интересы."
            ...
            n "У неё был слишком застенчивый характер и она не умела подбирать слова в нужный момент..."
